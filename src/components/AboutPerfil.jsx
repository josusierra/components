...
function Profile({ datosPerfil }) {
  let imagenPremium=null
  if (!datosPerfil.imagen) {
    datosPerfil.imagen="/rana-de-bosque-de-america-del-norte_c7a9e31d_800x800.jpg";
  }
  if (datosPerfil.isPremium) {
      imagenPremium=<img src="/1900194.webp" className="icono-premium" alt="icono-premium"/>
    ...
    <div className="contenedor">
      <div className="div-foto">
        <a href="data:image/jpeg;base64," target="_blank" rel="noopener noreferrer">
          <img src={datosPerfil.imagen} className="foto" alt="foto" />
        </a>
        {imagenPremium}
      ...
      <UserCard 
        ...
        habilidades={datosPerfil.habilidades} 
...
function Principal() {
  ...
  return (
    ...
    <div id="contenedor-perfiles" className="perfiles-contenedor">
    <div id="contenedor-about" className="contenedor-about"> <h1>About Us</h1></div>
    

      {perfiles.map((perfil, id) => (
        <Profile key={id} datosPerfil={perfil} />
      ))}
    </div>
  );
}
